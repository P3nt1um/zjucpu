...
HD_PWD='/home/pentium/zjucpu/zjucpu.runs/ClockGen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ClockGen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ClockGen.tcl
