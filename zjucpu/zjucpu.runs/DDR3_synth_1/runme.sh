...
HD_PWD='/home/pentium/zjucpu/zjucpu.runs/DDR3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDR3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDR3.tcl
